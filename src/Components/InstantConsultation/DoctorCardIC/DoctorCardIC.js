    ...
    <div className="doctor-card-container">
      ...
      <div className="doctor-card-options-container">
       <Popup
          ...
          trigger={
            <button className={`book-appointment-btn-instant-consultation ${appointments.length > 0 ? 'cancel-appointment-btn-instant-consultation' : ''}`}>
                ...
                <>
                  ...
                  {appointments.map((appointment) => (
                    <div className="bookedInfo" key={appointment.id}>
                      ...
                      <br/>
                      <button onClick={() => handleCancel(appointment.id)} className='book-appointment-btn-instant-consultation' >Cancel Appointment</button>
                    </div>
                  ))}
                </>
              ) : (
